      ...
      <div className="space-y-6">
        ...
        <div className="card p-5">
          ...
          <Toggle
            ...
            enabled={prefs.riskEscalations}
            onChange={() => toggle('riskEscalations')}
          />
          <Toggle
            icon={Mail}
            label="Weekly digest"
        ...
        <div className="card p-5">
          ...
          <Toggle
            ...
            enabled={prefs.autoAnalysis}
            onChange={() => toggle('autoAnalysis')}
          />
          <div className="border-b border-slate-100 py-4">
            ...
            <select value={riskThreshold} onChange={(e) => setRiskThreshold(e.target.value)} className={SELECT_CLASSES}>
              <option>Low</option>
