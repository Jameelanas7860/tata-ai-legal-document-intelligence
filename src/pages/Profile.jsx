...
export default function Profile() {
  ...
  const handleSave = async () => {
    const updates = { name: name.trim() || user?.name, role: role.trim() || user?.role };
    updateUser(updates);
    try {
          ...
          <div className="card p-5">
            ...
            {editing ? (
              ...
              <div className="py-1">
                ...
                <DetailRow icon={Building2} label="Organization" value={profile?.organization || 'Tata Group'} />
                <DetailRow icon={Calendar} label="Member since" value={profile?.memberSince || 'Recently'} />
              </div>
            )}
          </div>
